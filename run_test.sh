COLLECTION_PATH="${POSTMAN_API_URL}/collections/${POSTMAN_COLLECTION_UID}?apikey=${POSTMAN_API_KEY}"
ENVIRONMENT_PATH="${POSTMAN_API_URL}/environments/${POSTMAN_ENVIRONMENT_UID}?apikey=${POSTMAN_API_KEY}"
