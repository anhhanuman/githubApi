...
| **CICD**      | `github actions`                    | [CI jobs](https://github.com/anhhanuman/githubApi/actions/runs/5031513262)                                                                                                                                                                                                                                                                    | Jobs run `in parallel` to speed up tests                                                                                                                                                                     |
| **Report**    | `actions/upload-artifact@v3`        | [CI jobs artifacts](https://github.com/anhhanuman/githubApi/actions/runs/5031513262)                                                                                                                                                                                                                                                          | The test report is passed and failed `on-purpose` to demonstrate the capabilities of <br/> - Alerting the failure of system <br/> - Or test case need to be updated (Here the test case needs to be updated) |
